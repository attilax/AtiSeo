...
//	}
    ...
    public static Map<String, Object> Bean2Map(Object obj) {  
		 ...
		 */
	public static Object retry3(Closure closure, errEventProcess errEventProcess,String logRootDir) {
		 try {//retry1
			return closure.execute(null);
		} catch (Exception e) {
			filex.save_SF(core.getTrace(e),logRootDir+"\\"+filex.getUUidName()+"w1.txt" );
			
			try {//retry2
				return closure.execute(null);
			} catch (Exception e2) {
				filex.save_SF(core.getTrace(e2),logRootDir+"\\"+filex.getUUidName()+"w2.txt" );
				
				try {//retry3
					return closure.execute(null);
				} catch (Exception e3) {
					filex.save_SF(core.getTrace(e3),logRootDir+"\\"+filex.getUUidName()+"w3e.txt" );
					  core.err(e); 
					  try {
		...
		public static Handler new_cglib(Class<Handler> class1) {
			// TODO Auto-generated method stub
			return null;
		}  
